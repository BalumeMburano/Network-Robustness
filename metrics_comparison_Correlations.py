...
def main():
    try:
        ...
        while i in range(int(graphs)):
            ...
            #G=nx.random_regular_graph(5,100,seed=None)
        ...
        plt.xlabel('Correlation_Coeficient', fontsize=16)
        plt.ylabel('Metrics', fontsize=16)
        plt.title('Correlation coeficient of Metrics with Variance_of_Degrees',fontsize=20)
        print(df)
        plt.show()
        ...
        plt.xlabel('Correlation_Coeficient', fontsize=16)
        plt.ylabel('Metrics', fontsize=16)
        plt.title('Correlation coeficient of Metrics with Average_Shortest_Path',fontsize=20)
        print(df)
        plt.show()
        ...
        plt.xlabel('Correlation_Coeficient', fontsize=16)
        plt.ylabel('Metrics', fontsize=16)
        plt.title('Correlation coeficient of Metrics with Assortative Coefficient',fontsize=20)
        print(df)
        plt.show()
        ...
        plt.xlabel('Correlation_Coeficient', fontsize=16)
        plt.ylabel('Metrics', fontsize=16)
        plt.title('Correlation coeficient of Metrics with Clustering Coefficient',fontsize=20)
        print(df)
        plt.show()
        ...
        df.to_csv('CorrelationResults_r.csv')
